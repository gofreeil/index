...
// ה-fit נשמר עם המודעה (landing._mainImageFit — לאוסף submitted-ads
// עמודות מוקלדות בלבד, ראו adsStore.js) ומוחל גם בתצוגות האמיתיות,
// כך שהדמו בבילדר הוא באמת "מה שרואים".
// ============================================================
