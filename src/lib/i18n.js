...
export const translations = {
	he: {
		...
		navigate: 'נווט',
		navigateDeviceApps: 'אפליקציות הניווט שבמכשיר',
		noDescription: 'אין תיאור זמין לעסק זה.',
		businessVideo: 'סרטון תדמית',
		socialNetworks: 'עקוב ברשתות החברתיות:',
		addressLabel: 'כתובת',
		moreLocations: 'סניפים ומקומות שירות נוספים',
		alsoSearchedAs: 'מחפשים אותנו גם כך',
		// ותק באתר — נספר מיום שהכרטיסייה עלתה (ראו tenure.js). המשך עצמו
		// ("שנה ו-3 חודשים") נבנה בקוד, כי זו נטייה דקדוקית ולא מחרוזת קבועה.
		tenureLabel: 'ותק באתר',
		tenureNew: 'חדש באתר',
		tenureSince: 'באתר מאז {date}',
		...
		login: 'התחברות',
		register: 'הרשמה',
		firstTimeRegister: '👋 פעם ראשונה כאן? כניסה עם Google יוצרת לך חשבון בלחיצה אחת.',
		email: 'אימייל',
		password: 'סיסמה',
		fullName: 'שם מלא',
		...
		// עריכת הפרופיל + שאלת ההיקף (החשבון משותף לכל אתרי יוצאים לחירות)
		profileEdit: 'עריכת פרטים',
		profileName: 'שם תצוגה',
		profileEmail: 'אימייל',
		profileEmailLocked: 'מזהה החשבון',
		profileScopeAsk: 'להחיל את השינוי בכל האתרים של יוצאים לחירות?',
		profileScopeHint:
			'החשבון שלכם משותף לכל אתרי הרשת. אפשר לעדכן את הפרטים בכולם בבת אחת, או רק במדריך הזה.',
		profileScopeAll: 'כן, בכל האתרים',
		profileScopeSite: 'לא, רק במדריך הזה',
		profileSavedAll: 'הפרטים עודכנו בכל אתרי יוצאים לחירות',
		profileSavedSite: 'הפרטים עודכנו במדריך הזה בלבד',
		profileLocalOnly: 'הפרטים האלה מוגדרים רק במדריך הזה. בשאר אתרי הרשת שמורים פרטים אחרים.',
		profileApplyEverywhere: 'החל בכל האתרים',
		profileMatchFound: 'מצאנו {n} כרטיסיות שנראות שלכם — לחצו כדי לדרוש אותן',
	...
	en: {
		...
		navigate: 'Navigate',
		navigateDeviceApps: 'Navigation apps on this device',
		noDescription: 'No description available for this business.',
		businessVideo: 'Business Video',
		socialNetworks: 'Follow on social media:',
		addressLabel: 'Address',
		moreLocations: 'Additional branches & service locations',
		alsoSearchedAs: 'Also found as',
		tenureLabel: 'On the site',
		tenureNew: 'New here',
		tenureSince: 'On the site since {date}',
		...
		register: 'Register',
		firstTimeRegister:
			'👋 First time here? Signing in with Google creates your account in one click.',
		email: 'Email',
		password: 'Password',
		fullName: 'Full Name',
		...
		or: 'or',
		registerWithFreedom: 'I have an account on the Out to Freedom community site',
		ssoRecognizeHint:
			"Being in the WhatsApp groups isn't a site account. If you don't have one yet, signing in with Google above creates it in one click.",
		...
		profileEmail: 'Email',
		profileEmailLocked: 'account ID',
		profileScopeAsk: 'Apply this change across all Yotzim LaHerut sites?',
		profileScopeHint:
			'Your account is shared across the whole network. You can update your details everywhere at once, or only in this directory.',
		profileScopeAll: 'Yes, all sites',
		profileScopeSite: 'No, this directory only',
		profileSavedAll: 'Your details were updated across all Yotzim LaHerut sites',
		profileSavedSite: 'Your details were updated in this directory only',
		profileLocalOnly:
			'These details are set for this directory only. Other sites in the network hold different details.',
		profileApplyEverywhere: 'Apply everywhere',
		profileMatchFound: 'We found {n} listings that look like yours — tap to claim them',
	...
	ru: {
		...
		navigate: 'Навигация',
		navigateDeviceApps: 'Приложения навигации на устройстве',
		noDescription: 'Описание для этого бизнеса отсутствует.',
		businessVideo: 'Видео о бизнесе',
		socialNetworks: 'Подписывайтесь в соцсетях:',
		addressLabel: 'Адрес',
		moreLocations: 'Дополнительные филиалы и адреса обслуживания',
		alsoSearchedAs: 'Нас также ищут как',
		tenureLabel: 'Стаж на сайте',
		tenureNew: 'Новичок на сайте',
		tenureSince: 'На сайте с {date}',
		...
		firstTimeRegister: '👋 Впервые здесь? Вход через Google создаёт аккаунт в один клик.',
		...
		or: 'или',
		registerWithFreedom: 'У меня есть аккаунт на сайте сообщества «Навстречу свободе»',
		ssoRecognizeHint:
			'Участие в группах WhatsApp — это не аккаунт на сайте. Если аккаунта ещё нет, вход через Google выше создаст его в один клик.',
		...
		myPhonePlaceholder: '050-0000000',
		profileEdit: 'Изменить данные',
		profileName: 'Отображаемое имя',
		profileEmail: 'Email',
		profileEmailLocked: 'идентификатор',
		profileScopeAsk: 'Применить изменение на всех сайтах «Йоцим ла-Херут»?',
		profileScopeHint:
			'Ваш аккаунт общий для всей сети. Можно обновить данные сразу везде или только в этом каталоге.',
		profileScopeAll: 'Да, на всех сайтах',
		profileScopeSite: 'Нет, только здесь',
		profileSavedAll: 'Данные обновлены на всех сайтах сети',
		profileSavedSite: 'Данные обновлены только в этом каталоге',
		profileLocalOnly:
			'Эти данные заданы только для этого каталога. На других сайтах сети сохранены другие данные.',
		profileApplyEverywhere: 'Применить везде',
		profileMatchFound: 'Мы нашли {n} карточек, похожих на ваши — нажмите, чтобы заявить права',
