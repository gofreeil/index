				...
				<div class="mt-20">
					<div class="mb-10 flex flex-col items-center justify-center text-center">
						...
						<div class="mt-4 flex gap-2">
							<span
								class="animate-pulse-glow inline-flex items-center rounded-full bg-gradient-to-r from-green-400 to-emerald-500 px-4 py-2 text-sm font-bold text-white shadow-lg"
							>
								<svg
									class="animate-spin-slow mr-1.5 h-4 w-4"
									fill="currentColor"
									viewBox="0 0 20 20"
								>
									<path
