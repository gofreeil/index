...
export const actions = {
	...
	save: async ({ request, locals }) => {
		...
		// מספר התמונות שעלו מופיע בהודעה — מי שצירף 5 ורואה "2 תמונות" יודע
		// מיד שחלק לא נקלטו (למשל גרירה מדף אינטרנט במקום קובץ מהמחשב)
		const n = uploadedByIndex.size;
		const imgNote = n ? ` (הועלו ${n === 1 ? 'תמונה אחת' : n + ' תמונות'})` : '';
