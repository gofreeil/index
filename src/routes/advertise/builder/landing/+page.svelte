            ...
            <section class="step-card">
                ...
                <div class="pay-box">
                    ...
                    <div class="pay-duration" role="group" aria-label="תקופת הפרסום">
                        ...
                        <button type="button" class="pay-duration-btn" class:active={payDuration === 30} onclick={() => setPayDuration(30)}>חודש</button>
                    ...
                    {:else}
                        ...
                        <a
                            href={"https://wa.me/972508750632?text=" + encodeURIComponent(`שלום, אני מעלה פרסומת באתר מדריך בעלי המקצוע ורוצה לתאם תשלום לתקופה של ${payDurationLabel}`)}
                            target="_blank"
